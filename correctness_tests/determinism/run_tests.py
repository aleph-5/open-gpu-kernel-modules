#!/usr/bin/env python3
"""run_tests.py - determinism test runner
...
def main():
    parser = argparse.ArgumentParser(description="determinism test runner")
    ...
    print(color(f"  determinism - {len(binaries)} test(s)", ANSI_BOLD))
    print(color(f"{'='*60}", ANSI_BOLD))
    print()
