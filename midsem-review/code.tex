...
All development and testing is carried out on a dedicated virtual machine named \texttt{dirtyuvm}, running a custom kernel with the modified NVIDIA UVM driver loaded as a kernel module.
...
\subsection*{Tests}
User-space tests are located in the \texttt{tests/} directory at the repository root, organised into the following subdirectories:
